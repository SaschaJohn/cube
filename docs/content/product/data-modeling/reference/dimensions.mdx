...
The `html` parameter allows you to define an HTML fragment associated with a dimension.
...
dimension on which the fragment is defined. Otherwise, it will result in duplicate rows in
the result set.
